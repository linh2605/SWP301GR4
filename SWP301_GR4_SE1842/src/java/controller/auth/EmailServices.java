...
public class EmailServices {
    ...
    public static boolean send(String emailTo, String emailSubject, String emailContent) {
        final String email = "orgbookaholic@gmail.com";
        final String pass = "pwwh ltsw gluv raor";
        //final String email = "ronaldosportshop@gmail.com";
        //final String pass = "wzcm iuza hzpy moxx";
    ...
    public static boolean sendRefundUpdate(Order order, int refundStatus, String reason) {
        String subject = "";
        String message = "";
        switch (refundStatus) {
            case 1:
        ...
        return send(order.getCusEmail(), subject, message);
    }
