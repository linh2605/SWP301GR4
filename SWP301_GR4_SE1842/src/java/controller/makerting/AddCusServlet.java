...
public class AddCusServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("view/addnewcustomer.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        User ac = new User(4, username, password, fullName, gender, phone, email, address);
        ...
        if (ud.createUser(ac)) {
            ...
            request.setAttribute("errorMess", "Add Fails");
        }
        request.getRequestDispatcher("view/addnewcustomer.jsp").forward(request, response);
