...
public class SendContact extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String con_message = request.getParameter("con_message");
            String mess = "Send contact succesfully";
            if (con_name == "") {
            ...
            System.out.println("biet cai lon");
            new BookReivewDAO().sendContact(con_name, con_email, con_message);
            request.getRequestDispatcher("./client/contact.jsp").forward(request, response);
        } catch (Exception e) {
            e.printStackTrace();
        }
