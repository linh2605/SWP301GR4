...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    User existingUser = new UserDao().getByEmail(email);
    if (existingUser != null && existingUser.getId() != u.getId()) {
    ...
    if (new UserDao().update(u)) {
        ...
        session.setAttribute("usersession", u); // Update user in session
    } else {
