...
public class BlogDAO extends DBContext {
    ...
    public ArrayList<Blog> getPostMarketing(String category, int author, int status, int sort, String search, int order) {
        ...
        try {
            ...
            String sql = "select b.blog_id,b.blog_title,substring(b.description,0,130),b.img,b.active,s.value,u.[UserFullName] from blog b join setting s on s.setting_id = b.blog_category join [user] u on u.[UserID] = b.author_id where 1 = 1 and s.value like ? and b.author_id between ? and ? and b.active between ? and ? and b.blog_title like ? ";
