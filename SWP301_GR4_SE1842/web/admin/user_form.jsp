...
<html lang="en">
    ...
    <head>
        ...
        <title>Product - Responsive Bootstrap 4 Admin Dashboard Template</title>
                                        ...
                                        <div class="table-responsive">
                                            <table class="data-tables table table-striped table-bordered" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th style="width: 3%;">#</th>
                                                        <th style="width: 12%;">Product Cover</th>
                                                        <th style="width: 15%;">Product Name</th>
                                                        <th style="width: 15%;">Product Category</th>
                                                        <th style="width: 15%;">Product Author</th>
                                                        <th style="width: 15%;">Product Publisher</th>
            ...
            <div class="iq-colorbox color-fix">
                ...
                <div id="right-sidebar-scrollbar" class="iq-colorbox-inner">
                    <div class="clearfix color-picker">
                        <h3 class="iq-font-black">Productsto Awesome Color</h3>
