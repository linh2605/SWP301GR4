                    ...
                    <div class="col-sm-12">
                        <div class="iq-card">
                            ...
                            <div class="iq-card-body">
                                <form enctype="multipart/form-data" action="products" method="POST" id="book__form" class="needs-validation" novalidate="">
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/products" class="btn btn-danger">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
