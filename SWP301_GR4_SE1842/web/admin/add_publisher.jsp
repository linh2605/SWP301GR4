        ...
        <script defer>
            document.addEventListener('DOMContentLoaded', function () {
                Validator({
                    ...
                    rules: [
                        Validator.isRequired('#c-name', 'Please enter name of publisher!'),
                        Validator.isRequired('#c-email', 'Please enter email of publisher!'),
                        Validator.isEmail('#c-email', 'Invalid Email!'),
                        Validator.isRequired('#c-phone', 'Please enter phone number of publisher!'),
                        Validator.isPhone('#c-phone', 'Invalid phone number!'),
                    ]
                });
                            ...
                            <div class="col-sm-12">
                                <div class="iq-card">
                                    ...
                                    <div class="iq-card-body">
                                        <form id="cat__form" action="update_publisher" method="Post">
                                            <input name="c-action" type="text" id="c-action" value="${action}">
                                        <input name="c-id" value="${cat.id}" type="text">
                                        ...
                                        <div class="form-group">
                                            <label>Publisher Mail:</label>
                                            <input id="c-email" name="c-email" value="${cat.email}" type="text" class="form-control">
                                            <span class="form-message"></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Publisher Phone:</label>
                                            <input id="c-phone" name="c-phone" value="${cat.phone}" type="text" class="form-control">
                                            <span class="form-message"></span>
                                        </div>
