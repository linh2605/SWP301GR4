...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="iq-card">
                                    <div class="iq-card-header d-flex justify-content-between">
                                        ...
                                        <div class="iq-card-header-toolbar d-flex align-items-center">
                                            <a href="categories?action=add" class="btn btn-primary">Add New Category</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="flex align-items-center list-user-action">
                                                                <div>
                                                                    <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="categories?cid=${c.id}"><i class="ri-pencil-line"></i></a>
                                                                </div>
                                                                <div onclick="loadCid(${c.id})" data-toggle="modal" data-target="#c-detele-confirmation">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <input hidden type="text" id="c-id" name="c-id">
                        By clicking Delete button, you will delete all sub-category of this category!<br>
                        Do you still want to delete?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button onclick="deleteCat(document.getElementById('c-id').value)" type="button" class="btn btn-danger">Delete</button>
                    </div>
                </div>
            </div>
        </div>        
        ...
        <script>
            ...
            function loadCid(cid) {
                document.querySelector('#c-id').value = cid;
            }
        </script>
