...
<html lang="en">
    ...
    <body>
                                ...
                                <div class="iq-card">
                                    <div class="iq-card-header d-flex justify-content-between">
                                        ...
                                        <div class="iq-card-header-toolbar d-flex align-items-center">
                                            <a href="add_author" class="btn btn-primary">Add New Designer</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="data-tables table table-striped table-bordered" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th width="5%">No</th>
                                                        <th width="20%">Designer Name</th>
                                                        <th width="65%">Designer Bio</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="flex align-items-center list-user-action">
                                                                <div>
                                                                    <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="update_author?aid=${a.id}"><i class="ri-pencil-line"></i></a>
                                                                </div>
                                                                <div>
                                                                    <a class="bg-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="delete-author?aid=${a.id}"><i class="ri-delete-bin-line"></i></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
        ...
        <div class="modal fade" id="a-detele-confirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Deleting Designer</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <input hidden type="text" id="a-id" name="a-id">
                        By clicking Delete button, you will delete all sub-category of this author!<br>
                        Do you still want to delete?
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                        <button onclick="deleteCat(document.getElementById('a-id').value)" type="button" class="btn btn-danger">Delete</button>
                    </div>
                </div>
            </div>
        </div>        
        ...
        <script>
            ...
            function loadCid(aid) {
                document.querySelector('#a-id').value = aid;
            }
        </script>
