...
<html lang="zxx">
    ...
    <head>
        ...
        <title>SportShop - Homepage</title>
            ...
            ===================================== -->
                <section class="hero-area hero-slider-3">
                    <div class="sb-slick-slider" data-slick-setting='{
                        ...
                        <div class="single-slide bg-image  bg-overlay--dark" data-bg="${pageContext.request.contextPath}/client/assets/image/bg-images/home-3-slider-1.jpg">
                        <div class="container">
                    ...
                    <div class="single-slide bg-image  bg-overlay--dark" data-bg="${pageContext.request.contextPath}/client/assets/image/bg-images/home-3-slider-2.jpg">
                        <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a href="${pageContext.request.contextPath}/shop" class="promo-image promo-overlay">
                                <img src="${pageContext.request.contextPath}/client/assets/image/bg-images/promo-banner-with-text.jpg" alt="">
                            </a>
                        </div>
                        <div class="col-lg-6">
                            <a href="${pageContext.request.contextPath}/shop" class="promo-image promo-overlay">
                                <img src="${pageContext.request.contextPath}/client/assets/image/bg-images/promo-banner-with-text-2.jpg" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="home-left-sidebar">
                                ...
                                <div class="single-side">
                                    <a href="${pageContext.request.contextPath}/shop" class="promo-image promo-overlay">
                                        <img src="${pageContext.request.contextPath}/client/assets/image/bg-images/promo-banner-small-with-text.jpg" alt="">
                                    </a>
                                </div>
                            </div>
                        </div>
