                                                        ...
                                                        <form method="post" action="FeedbackDetail">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <input readonly type="text" value="${f.user.username}" name="" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>Email: </label>
                                                                    <input readonly type="text" value="${f.user.email}" name="" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>Product Name: </label>
                                                                    <input readonly type="text" value="${f.book.title}" name="" class="form-control">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <label>Star: </label>
