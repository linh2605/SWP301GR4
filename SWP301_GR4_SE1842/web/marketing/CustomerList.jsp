                                        ...
                                        <table class="panel-body table-responsive" id="slidetable" cellspacing="0" style="width: 100%;">
                                            <thead>
                                                <tr style="cursor: pointer; font-size: 15px; border-bottom: 1px solid #ccc; text-align: center;">
                                                    ...
                                                    <th>User Full Name <i class="fa fa-caret-down" aria-hidden="true"></i></th>
                                                    <th>User Email</t>
                                                    <th>User Phone  <i class="fa fa-caret-down" aria-hidden="true"></i></th>
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach var="u" items="${userList}">
                                                    <tr>
                                                        ...
                                                        <td>${u.getAddress()}</td>
                                                        <td>${u.getGender()}</td>
                                                        <td><button class="btn btn-info look-button" data-toggle="modal" data-target="#userModal${u.getId()}">Look</button></td>
                                                    </tr>
                                                    <!-- Main content -->
                                                <div class="modal fade" id="userModal${u.getId()}" tabindex="-1" role="dialog" aria-labelledby="userModalLabel" aria-hidden="false">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="form-group col-md-6">
                                                                                            ...
                                                                                            <input class="form-control" type="text" readonly="" value="${u.getFullName()}">
                                                                                            <input class="form-control" type="hidden" name="fid" readonly="" value="${u.getFullName()}">
                                                                                        </div>
                                                                                        <div class="form-group col-md-6">
                                                                                            <label for="exampleSelect1" class="control-label">Email</label>
                                                                                            <input class="form-control" type="text" id="stitle" value="${u.getEmail()}" readonly="">
                                                                                            <span id="invalid1" style="color: red;"> </span>

                                                                                        </div>
                                                                                        <div class="form-group col-md-6">
                                                                                            <label class="control-label">Phone</label>
                                                                                            <input class="form-control" type="text" readonly="" value="${u.getPhone()}">
                                                                                        </div>
                                                                                        <div class="form-group col-md-6">
                                                                                            <label for="exampleSelect1" class="control-label">Address</label>
                                                                                            <input class="form-control" type="text" readonly="" value="${u.getAddress()}" readonly="">

                                                                                        </div>
                                                                                        <div class="form-group col-md-12">
                                                                                            <label class="control-label">Gender</label>
                                                                                            <input readonly="" class="form-control"value="${u.getGender()}" ></input>
                                                                                        </div>
